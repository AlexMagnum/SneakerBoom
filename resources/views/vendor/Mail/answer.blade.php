            ...
            <span style="display: inline-block; max-width: 800px; width: 100%; text-align: center;">
             ...
             <h1><a href="http://sneakerboom.ho.ua/"><img style="width: 256px"
                             ...
                             <span style="display:inline-block; width:800px;"><h2>
                                 ...
                                 <p style="font-size: 14px">Ви отримали відповідь на ваше звернення
                                 <br>на сайті sneakerboom.ho.ua</p>
                                       <b>Ваше запитання:</b>
                                        <br>{{$question}}
<br><br><br><br>
                                 <b style="margin-top: 50px;">Наша відповідь:</b><br>
                                 {!! $msg !!}

            </span>
                            <span style="display:inline-block; width:800px; padding-top: 35px;">
                                 <p style="font-size: 14px">Дякуємо, за Ваше зверення! Надіємося ми змогли Вам допомогти!
                                 <br>З повагою і найкращими побажаннями команда sneakerboom.ho.ua!
                                  </p>
                            </span>
