                            ...
                            <div class="form-group">
                                ...
                                <div class="select2-purple">
                                    <select class="select2" multiple="multiple" data-placeholder="Виберіть підкатегорію"
                                            data-dropdown-css-class="select2-purple" style="width: 100%;" name="subcategory[]" required>
                                ...
                                <div class="form-group" style="margin-top: 20px">
                                    ...
                                    <input type="text" class="form-control" id="manufacturer" name="manufacturer"
                                           placeholder="Назва виробника" required>
                                </div>
                                <div class="form-group">
                                    <label for="model">Модель*</label>
                                    <input type="text" class="form-control" id="model" name="model"
                                           placeholder="Назва моделі" required>
                                </div>
                                <div class="form-group">
                                    <label for="code">Код товару*</label>
                                    <input type="text" class="form-control" id="code" name="code"
                                           placeholder="Код товару (артикул)" required>
                                </div>
                                <div class="form-group">
                                    <label for="price">Ціна*</label>
                                    <input type="text" class="form-control" id="price" name="price"
                                           placeholder="Ціна товару" required>
                                </div>
                                <div class="form-group">
                                    <label for="count">Кількість одиниць на складі*</label>
                                    <input type="text" class="form-control" id="count" name="count"
                                           placeholder="Кількість товару" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="color" name="color"
                                           placeholder="Колір товару" required>
                                </div>
                                <div class="form-group">
                                    <label>Розміри товару*:</label>
                                    <div class="select2-purple">
                                        <select class="select2" multiple="multiple" data-placeholder="Вкажіть доступні розміри"
                                                data-dropdown-css-class="select2-purple" style="width: 100%;" name="size[]" required>
                                            @if(count($size) > 0)
                                                @foreach($size as $s)
                                ...
                                <div class="form-group" style="margin-top: 20px">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="images">Виберіть файли (1-4)</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="slider_desc">
                                    ...
                                    <input type="text" class="form-control" id="slider_slog" name="slider_slog"
                                           placeholder="Підпис до картинки у слайдері">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="highlights" name="highlights"></textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <button type="submit" class="btn btn-primary">Додати новий товар до бази</button>
                            </div>
                        </div>
                    </form>
                </div>
